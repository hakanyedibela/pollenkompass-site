...
export type Lang = "de" | "en" | "es" | "ro" | "tr";
...
export const UI = {
  ...
  reading: { de: "Messwert", en: "Reading", es: "Medición", ro: "Măsurătoare", tr: "Ölçüm" },
  stripLegend: {
    ...
    tr: "ePIN polen ölçeği · altı düzey",
  },
  skillLevelOf: {
    de: "Stufe %1 von %2",
    en: "level %1 of %2",
...
export const HERO = {
  ...
  h1Pre: {
    ...
    tr: "Şunu yapan yazılımlar geliştiriyorum: ",
  },
  h1Em: {
  ...
  role: {
    ...
    tr: "Full-stack geliştirici. Ölçülmüş veriler, dürüst durumlar ve bilmediğini kabul eden arayüzler — çünkü kendinden emin bir yanlış cevap, hiç cevap vermemekten kötüdür.",
  },
} as const;
...
export const SCALE: { name: L; hex: string }[] = [
  {
    name: { de: "sehr wenig", en: "very little", es: "muy poco", ro: "foarte puțin", tr: "çok az" },
    hex: "#298d31",
  },
  { name: { de: "wenig", en: "little", es: "poco", ro: "puțin", tr: "az" }, hex: "#97c000" },
  { name: { de: "mäßig", en: "some", es: "moderado", ro: "moderat", tr: "orta" }, hex: "#fceb00" },
  { name: { de: "viel", en: "a lot", es: "mucho", ro: "mult", tr: "yüksek" }, hex: "#f2b01d" },
  {
    name: { de: "sehr viel", en: "very much", es: "muchísimo", ro: "foarte mult", tr: "çok yüksek" },
    hex: "#df4c06",
  },
  {
    name: { de: "extrem viel", en: "extremely much", es: "extremo", ro: "extrem de mult", tr: "aşırı yüksek" },
    hex: "#b5111c",
  },
];
...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    title: { de: "Client", en: "Client", es: "Cliente", ro: "Client", tr: "İstemci" },
    blurb: {
      ...
      tr: "İnsanların gerçekten kullandığı arayüzler — ekran okuyucu kullananlar dahil.",
    },
    skills: [
      {
        name: "Swift / SwiftUI",
        level: 6,
        note: {
          de: "Pollenkompass iOS: CloudKit-Sync, Siri, App Intents",
          en: "Pollenkompass iOS: CloudKit sync, Siri, App Intents",
          es: "Pollenkompass iOS: sincronización con CloudKit, Siri, App Intents",
          ro: "Pollenkompass iOS: sincronizare CloudKit, Siri, App Intents",
          tr: "Pollenkompass iOS: CloudKit eşitlemesi, Siri, App Intents",
        },
      },
      {
        ...
        level: 5,
        note: {
          de: "Pollenkompass Android: gleiche Invarianten, natives UI, Widgets",
          en: "Pollenkompass Android: same invariants, native UI, widgets",
          es: "Pollenkompass Android: las mismas invariantes, interfaz nativa, widgets",
          ro: "Pollenkompass Android: aceleași invariante, interfață nativă, widgeturi",
          tr: "Pollenkompass Android: aynı invariantlar, yerel arayüz, widgetlar",
        },
      },
      {
  ...
  {
    title: { de: "Services", en: "Services", es: "Servicios", ro: "Servicii", tr: "Servisler" },
    blurb: {
      ...
      tr: "Verinin bir vaat olmaktan çıkıp sözleşmeye dönüştüğü katman.",
    },
    skills: [
      {
        ...
        note: {
          ...
          tr: "ePIN ölçüm ağı + DWD açık verileri",
        },
      },
      {
        ...
        note: {
          ...
          tr: "Önce önbellek, dürüst eskime",
        },
      },
  ...
  {
    title: { de: "Arbeitsweise", en: "Practice", es: "Método", ro: "Mod de lucru", tr: "Çalışma biçimi" },
    blurb: {
      ...
      tr: "İşin nasıl yapıldığı — gerçek kullanıcılara dayanıp dayanmadığını belirleyen kısım.",
    },
    skills: [
      {
        ...
        note: {
          ...
          tr: "Pollenkompass'ta platform başına 270+ test",
        },
      },
...
export const WORK = {
  ...
  iconAlt: {
    ...
    tr: "Pollenkompass uygulama simgesi: polen taneli pusula gülü",
  },
  subtitle: {
    ...
    tr: "Almanya için bir alerji yardımcısı — iOS ve Android",
  },
  body: [
    {
      ...
      tr: "Bavyera LGL'nin ePIN ölçüm ağından canlı ölçülen polen yoğunluklarını okur, Almanya'nın 27 bölgesi için günlük DWD tahminini gösterir ve her ikisini de tam olarak takip ettiğiniz alerjenler için yorumlar. Ölçümler ve tahminler asla karıştırılmaz — her sayı kaynağını taşır.",
    },
    {
      ...
      tr: "Zor olan normal durum değil. API'nin 200 döndürdüğü ama istasyonun sessizce ölçmeyi bıraktığı gündür. Uygulama bunu söyler, son gerçek ölçümün tarihini belirtir ve veriler döndüğünde haber verir — kendinden emin bir sıfır göstermek yerine.",
    },
    {
      de: "Dazu kommen ein Symptomtagebuch mit Pollen-Schnappschüssen, Korrelationsansichten, Warnungen — und auf Android Homescreen-Widgets. Kein Konto, keine Werbung, kein Tracking — das Tagebuch bleibt auf deinem Gerät (auf iOS optional in deiner privaten iCloud). Beide Apps teilen dieselben Invarianten: iOS nativ in SwiftUI, Android nativ in Kotlin mit Jetpack Compose.",
      en: "A symptom diary with pollen snapshots, correlation views, alerts — and, on Android, home-screen widgets — round it out. No account, no ads, no tracking — the diary stays on your device (and, on iOS, optionally in your private iCloud). Both apps share the same invariants: iOS native in SwiftUI, Android native in Kotlin with Jetpack Compose.",
      es: "A eso se suman un diario de síntomas con instantáneas de polen, vistas de correlación, avisos y, en Android, widgets en la pantalla de inicio. Sin cuenta, sin anuncios, sin seguimiento — el diario se queda en su dispositivo (y, en iOS, opcionalmente en su iCloud privado). Ambas apps comparten las mismas invariantes: iOS nativo en SwiftUI, Android nativo en Kotlin con Jetpack Compose.",
      ro: "La acestea se adaugă un jurnal de simptome cu instantanee de polen, vederi de corelație, alerte și, pe Android, widgeturi pe ecranul principal. Fără cont, fără reclame, fără urmărire — jurnalul rămâne pe dispozitivul dumneavoastră (iar pe iOS, opțional, în iCloud-ul privat). Ambele aplicații au aceleași invariante: iOS nativ în SwiftUI, Android nativ în Kotlin cu Jetpack Compose.",
      tr: "Buna polen anlık görüntüleriyle bir şikâyet günlüğü, ilişki görünümleri, uyarılar ve Android'de ana ekran widgetları eklenir. Hesap yok, reklam yok, izleme yok — günlük cihazınızda kalır (iOS'ta isteğe bağlı olarak özel iCloud'unuzda). Her iki uygulama da aynı invariantları paylaşır: iOS'ta SwiftUI, Android'de Kotlin ve Jetpack Compose ile yerel geliştirme.",
    },
  ],
  facts: [
    {
    ...
    },
    {
      ...
      value: {
        de: "iOS 18+ (SwiftUI) · Android (Kotlin/Compose)",
        en: "iOS 18+ (SwiftUI) · Android (Kotlin/Compose)",
        es: "iOS 18+ (SwiftUI) · Android (Kotlin/Compose)",
        ro: "iOS 18+ (SwiftUI) · Android (Kotlin/Compose)",
        tr: "iOS 18+ (SwiftUI) · Android (Kotlin/Compose)",
      },
    },
    {
      label: { de: "Tests", en: "Tests", es: "Pruebas", ro: "Teste", tr: "Testler" },
      value: {
        ...
        tr: "Platform başına 270+, erişilebilirlik denetimleri dahil",
      },
    },
    {
      label: { de: "Preis", en: "Price", es: "Precio", ro: "Preț", tr: "Fiyat" },
      value: {
        ...
        tr: "Ücretsiz — reklam yok, uygulama içi satın alma yok",
      },
    },
  ],
  skillsEyebrow: {
  ...
  skillsTitle: {
    ...
    tr: "Verilerle aynı ölçekte ölçülmüş",
  },
  skillsProse: {
    ...
    tr: "Altı düzey, tek bir anlam: 1. düzey çalışma bilgisi, 6. düzey insanların beni aradığı şeydir. Yüzde yok — kimse Swift'te %95 iyi değildir.",
  },
} as const;
