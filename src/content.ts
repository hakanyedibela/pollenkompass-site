    ...
    skills: [
      {
        ...
        note: {
          ...
          tr: "Pollenkompass iOS: CloudKit eşitlemesi, Siri, widgetlar",
        },
      },
      {
        ...
        note: {
          ...
          tr: "Pollenkompass Android: aynı invariantlar, yerel arayüz",
        },
      },
      {
...
export const WORK = {
  ...
  body: [
    ...
    },
    {
      ...
      tr: "Buna polen anlık görüntüleriyle bir şikâyet günlüğü, ilişki görünümleri, uyarılar ve widgetlar eklenir. Hesap yok, reklam yok, izleme yok — günlük cihazınızda kalır (iOS'ta isteğe bağlı olarak özel iCloud'unuzda). Her iki uygulama da aynı invariantları paylaşır: iOS'ta SwiftUI, Android'de Kotlin ve Jetpack Compose ile yerel geliştirme.",
    },
  ],
  facts: [
    {
    ...
    },
    {
      ...
      value: {
        ...
        tr: "iOS 17+ (SwiftUI) · Android (Kotlin/Compose)",
      },
    },
    {
